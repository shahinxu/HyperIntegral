...
arch_name, use_resnet, use_attention = architectures[0]  # Use ResNet
model = HyperPINNTopology(N=N, output_dim=4*N, use_resnet=use_resnet, use_attention=use_attention)
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=14000, eta_min=1e-6)
